local lang = {
  ...
  ["alerts_dashboard"] = {
    ...
    ["net_scan_detected"] = "Network Scan Detected",
  ...
  ["entity_thresholds"] = {
    ...
    ["net_scan_detection_description"] = "Trigger an alert when a network scan is detected when the number of incomplete TCP/UDP flows and number of contacts as client host exceeds the specified threshold.",
    ["net_scan_detection_title"] = "Network Scan Detection",
