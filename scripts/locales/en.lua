local lang = {
  ...
  ["entity_thresholds"] = {
    ...
    ["net_scan_detection_description"] = "Trigger an alert when a network scan is detected when the number of contacts as client host exceeds the specified threshold.",
